...
function setupReflector() {
  ...
  reflector.registerType(Dir0, {
    "factory": () => new Dir0(),
    "parameters": [],
    "annotations" : [new DecoratorAnnotation({selector: '[dir0]', bind: {'prop': 'attr0'}})]
  });

  reflector.registerType(Dir1, {
    "factory": (dir0) => new Dir1(dir0),
    "parameters": [[Dir0]],
    "annotations" : [new DecoratorAnnotation({selector: '[dir1]', bind: {'prop': 'attr1'}})]
  });

  reflector.registerType(Dir2, {
    "factory": (dir1) => new Dir2(dir1),
    "parameters": [[Dir1]],
    "annotations" : [new DecoratorAnnotation({selector: '[dir2]', bind: {'prop': 'attr2'}})]
  });

  reflector.registerType(Dir3, {
    "factory": (dir2) => new Dir3(dir2),
    "parameters": [[Dir2]],
    "annotations" : [new DecoratorAnnotation({selector: '[dir3]', bind: {'prop': 'attr3'}})]
  });

  reflector.registerType(Dir4, {
    "factory": (dir3) => new Dir4(dir3),
    "parameters": [[Dir3]],
    "annotations" : [new DecoratorAnnotation({selector: '[dir4]', bind: {'prop': 'attr4'}})]
  });
